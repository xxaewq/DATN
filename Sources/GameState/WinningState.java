            ...
            if (counter < 2) {
                if (this.choice == 1) { // Nếu lựa chọn là 1(Next Map)
                    ...
                    this.getGamepanel().getGamestatemanager().addState(
                            new PlayState(this.getGamepanel(), this.getGamepanel().getMapManager().getCurrentMap(),false)); 
                    ...
                    this.getGamepanel().getGamestatemanager().popState();
                    this.getGamepanel().getGamestatemanager().addState(new PlayState(this.getGamepanel(), inputpath,false));
                    ...
                    if (counter % 10 == 0)
                        if (this.choice == 1) {
                            ...
                            this.getGamepanel().getGamestatemanager().addState(new PlayState(this.getGamepanel(),
                                    this.getGamepanel().getMapManager().getCurrentMap(),false));
                            ...
                            this.getGamepanel().getGamestatemanager()
                                    .addState(new PlayState(this.getGamepanel(), inputpath,false));
